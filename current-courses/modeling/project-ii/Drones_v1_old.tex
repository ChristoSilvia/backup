...
\begin{figure}%
    \centering
    \subfloat[H Path of a drone given even number of grid squares]{{\includegraphics[width=4cm]{HPath.png} }}%
    \qquad
    \subfloat[U Path of a drone given even number of grid squares]{{\includegraphics[width=4cm]{UPath.png} }}%
