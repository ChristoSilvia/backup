...
plot([0, w, w, 0, 0], [0, 0, h, h, 0],'color','black','linewidth',1.0)

scatter(X(:,end,1),X(:,end,2))

angle = linspace(0,2*pi);
for i = 1:n_drones
	plot(X(i,end,1) + r*cos(angle), X(i,end,2) + r*sin(angle),'linewidth',1.0)
end

axis([0-0.1,w+0.1,0-0.1,h+0.1])

hold off
print('ideal-gas.png','-S900,600')
